...
class FP(FP_core):
    ...
    def SellPLUfromExtDB_HS(self, NamePLU, Price, HSCode, Quantity=None, DiscAddP=None):
        ...
        :type NamePLU: str\n
        :param Price: Up to 13 symbols for article's price\n
        :type Price: float\n
    ...
    def Subtotal(self, OptionDisplay, DiscAddV=None, DiscAddP=None):
        ...
        :param DiscAddV: Up to 13 symbols for the value of the 
...
class __DailyAmountsByVATRes__:
    """
    :param SaleVATGrA: Up to 15 symbols for the accumulated VAT in group A\n
    :type SaleVATGrA: float\n
    :param SaleVATGrB: Up to 15 symbols for the accumulated VAT in group B\n
    :type SaleVATGrB: float\n
    :param SaleVATGrC: Up to 15 symbols for the accumulated VAT in group C\n
    :type SaleVATGrC: float\n
    :param SaleVATGrD: Up to 15 symbols for the accumulated VAT in group D\n
    :type SaleVATGrD: float\n
    :param SaleTurnoverVATGrE: Up to 15 symbols for the accumulated turnover in group E\n
    :type SaleTurnoverVATGrE: float\n
    :param SaleTurnoverABCD: Up to 15 symbols for the sale turnover in VAT groups A, B, C, D\n
    :type SaleTurnoverABCD: float\n
    :param RefundVATGrA: Up to 15 symbols for the refund VAT in group A\n
    :type RefundVATGrA: float\n
    :param RefundVATGrB: Up to 15 symbols for the refund VAT in group B\n
    :type RefundVATGrB: float\n
    :param RefundVATGrC: Up to 15 symbols for the refund VAT in group C\n
    :type RefundVATGrC: float\n
    :param RefundVATGrD: Up to 15 symbols for the refund VAT in group D\n
    :type RefundVATGrD: float\n
    :param RefundTurnoverVATGrE: Up to 15 symbols for the refund accumulated turnover in group E\n
    :type RefundTurnoverVATGrE: float\n
    :param RefundTurnoverABCD: Up to 15 symbols for the refund turnover in VAT groups A, B, C, D\n
    :type RefundTurnoverABCD: float\n
    """
    def __init__(self, SaleVATGrA, SaleVATGrB, SaleVATGrC, SaleVATGrD, SaleTurnoverVATGrE, SaleTurnoverABCD, RefundVATGrA, RefundVATGrB, RefundVATGrC, RefundVATGrD, RefundTurnoverVATGrE, RefundTurnoverABCD):
        self.SaleVATGrA = SaleVATGrA
        self.SaleVATGrB = SaleVATGrB
        self.SaleVATGrC = SaleVATGrC
        self.SaleVATGrD = SaleVATGrD
        self.SaleTurnoverVATGrE = SaleTurnoverVATGrE
        self.SaleTurnoverABCD = SaleTurnoverABCD
        self.RefundVATGrA = RefundVATGrA
        self.RefundVATGrB = RefundVATGrB
        self.RefundVATGrC = RefundVATGrC
        self.RefundVATGrD = RefundVATGrD
        self.RefundTurnoverVATGrE = RefundTurnoverVATGrE
        self.RefundTurnoverABCD = RefundTurnoverABCD
...
class __CurrentReceiptInfoRes__:
    ...
    :param SubtotalAmountVATGA: Up to 13 symbols for subtotal by VAT group A\n
    :type SubtotalAmountVATGA: float\n
    :param SubtotalAmountVATGB: Up to 13 symbols for subtotal by VAT group B\n
    :type SubtotalAmountVATGB: float\n
    :param SubtotalAmountVATGC: Up to 13 symbols for subtotal by VAT group C\n
    :type SubtotalAmountVATGC: float\n
    :param SubtotalAmountVATGD: Up to 13 symbols for subtotal by VAT group D\n
    :type SubtotalAmountVATGD: float\n
    :param SubtotalAmountVATGE: Up to 13 symbols for subtotal by VAT group E\n
    ...
    :param reserved5: Up to 13 symbols\n
...
class __EODAmountsRes__:
    """
    :param EOD_sale_turnover: Up to 20 symbols for the EOD sale turnover\n
    :type EOD_sale_turnover: float\n
    :param EOD_credit_turnover: Up to 20 symbols for the EOD credit turnover\n
    :type EOD_credit_turnover: float\n
    :param EOD_saleVAT: Up to 20 symbols for the EOD VAT from sales\n
    :type EOD_saleVAT: float\n
    :param EOD_creditVAT: Up to 20 symbols for the EOD VAT from credit invoices\n
